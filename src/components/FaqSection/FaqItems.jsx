...
const FaqItems = ({ item }) => {
  ...
  return (
    <div className="p-3 lg:-5 rounded-[5px] border border-soild border-[#D9DCE2] mb-5 cursor-pointer">
      <div
        className="flex items-center justify-between gap-5"
        onClick={toggleAccordion}
      >
        <h4 className="text-[16px] leading-7 lg:text-[22px] font-[700] lg:leading-8 text-headingColor">
          {item.question}
        </h4>
        <div
          className={`${
